...
String translate(String key) {
  final Map<String, Map<String, String>> dictionary = {
    'en': {
      ...
      'dialog_diet': 'Recommended Diet',
      'dialog_disease': 'Common Diseases' // <-- NEW KEY
    },
    'hi': {
      ...
      'dialog_diet': 'अनुशंसित आहार',
      'dialog_disease': 'सामान्य बीमारियां' // <-- NEW KEY
    },
    'mr': {
      ...
      'dialog_diet': 'सुचवलेला आहार',
      'dialog_disease': 'सामान्य आजार' // <-- NEW KEY
    },
  };
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  // <-- UPDATED: Now speaks about diseases too! -->
  Future<void> _speakCattleDetails(String breedName, Map<String, String> details) async {
    ...
    String safeDisease = details['disease'] ?? "";

    if (lang == 'hi') {
      await flutterTts.setLanguage("hi-IN");
      safeLifespan = safeLifespan.replaceAll('-', ' से ');
      safeMilk = safeMilk.replaceAll('-', ' से ');
      textToSpeak = "यह $safeName प्रजाति है। इसका मूल स्थान $safeOrigin है। इसका जीवनकाल $safeLifespan है, और यह प्रतिदिन $safeMilk देती है। इसका अनुशंसित आहार है: $safeDiet। सामान्य बीमारियों से सावधान रहें जैसे: $safeDisease";
    } else if (lang == 'mr') {
      await flutterTts.setLanguage("mr-IN");
      safeLifespan = safeLifespan.replaceAll('-', ' ते ');
      safeMilk = safeMilk.replaceAll('-', ' ते ');
      textToSpeak = "ही $safeName प्रजाती आहे. याचे मूळ स्थान $safeOrigin आहे. याचे आयुर्मान $safeLifespan आहे, आणि हे दररोज $safeMilk देते. याचा सुचवलेला आहार आहे: $safeDiet. सामान्य आजारांपासून सावध रहा जसे: $safeDisease";
    } else {
      await flutterTts.setLanguage("en-IN");
      safeLifespan = safeLifespan.replaceAll('-', ' to ');
      safeMilk = safeMilk.replaceAll('-', ' to ');
      textToSpeak = "This is the $safeName breed. It originates from $safeOrigin. It has a lifespan of $safeLifespan, and produces $safeMilk. Its recommended diet is: $safeDiet. Be aware of common diseases like: $safeDisease";
    }
  ...
  // --- UPDATED: DATABASE WITH DIET & DISEASES ---
  Map<String, String> getBreedInfo(String breedName) {
    ...
    if (lang == 'hi') {
      breedData = {
        'gir': {'name': 'गिर', 'type': 'गाय', 'origin': 'गुजरात (सौराष्ट्र)', 'lifespan': '12-15 वर्ष', 'milk': '12-20 लीटर/दिन', 'weight': '385-545 किग्रा', 'height': '130-140 सेमी', 'appearance': 'उत्तल माथा, लंबे लटकते कान, लाल/धब्बेदार।', 'diet': 'हरा चारा (15-20 किलो), सूखा चारा (5-7 किलो), दाना (3-4 किलो), खनिज (50 ग्राम)।', 'disease': 'थनैला (Mastitis), खुरपका-मुंहपका (FMD), और लम्पी त्वचा रोग।'},
        'sahiwal': {'name': 'साहीवाल', 'type': 'गाय', 'origin': 'पंजाब/हरियाणा', 'lifespan': '14-16 वर्ष', 'milk': '10-15 लीटर/दिन', 'weight': '400-500 किग्रा', 'height': '120-130 सेमी', 'appearance': 'लाल-भूरा रंग, भारी त्वचा की सिलवटें।', 'diet': 'हरा चारा (15-20 किलो), सूखा चारा (5-7 किलो), दाना (3-4 किलो), खनिज (50 ग्राम)।', 'disease': 'थनैला (Mastitis), खुरपका-मुंहपका (FMD), और लम्पी त्वचा रोग।'},
        'kankrej': {'name': 'कांक्रेज', 'type': 'गाय', 'origin': 'गुजरात/राजस्थान', 'lifespan': '12-16 वर्ष', 'milk': '8-10 लीटर/दिन', 'weight': '420-590 किग्रा', 'height': '130-140 सेमी', 'appearance': 'चांदी-भूरा रंग, बड़े मजबूत सींग।', 'diet': 'सूखा चारा (6-8 किलो), चराई, दाना मिश्रण (2 किलो) और नमक।', 'disease': 'थनैला (Mastitis), खुरपका-मुंहपका (FMD), और लम्पी त्वचा रोग।'},
        'ongole': {'name': 'ओंगोल', 'type': 'गाय', 'origin': 'आंध्र प्रदेश', 'lifespan': '15-20 वर्ष', 'milk': '5-8 लीटर/दिन', 'weight': '430-500 किग्रा', 'height': '135-150 सेमी', 'appearance': 'सफेद रंग, बड़ा कूबड़, मांसल शरीर।', 'diet': 'सूखा चारा (6-8 किलो), चराई, दाना मिश्रण (2 किलो) और नमक।', 'disease': 'थनैला (Mastitis), खुरपका-मुंहपका (FMD), और लम्पी त्वचा रोग।'},
        'red sindhi': {'name': 'लाल सिंधी', 'type': 'गाय', 'origin': 'सिंध/राजस्थान', 'lifespan': '12-15 वर्ष', 'milk': '12-18 लीटर/दिन', 'weight': '300-450 किग्रा', 'height': '115-130 सेमी', 'appearance': 'गहरा लाल रंग, गठीला शरीर, मोटे सींग।', 'diet': 'हरा चारा (15-20 किलो), सूखा चारा (5-7 किलो), दाना (3-4 किलो), खनिज (50 ग्राम)।', 'disease': 'थनैला (Mastitis), खुरपका-मुंहपका (FMD), और लम्पी त्वचा रोग।'},
        'tharparkar': {'name': 'थारपारकर', 'type': 'गाय', 'origin': 'राजस्थान', 'lifespan': '14-18 वर्ष', 'milk': '10-14 लीटर/दिन', 'weight': '400-500 किग्रा', 'height': '120-140 सेमी', 'appearance': 'सफेद/हल्का भूरा रंग।', 'diet': 'हरा चारा (15-20 किलो), सूखा चारा (5-7 किलो), दाना (3-4 किलो), खनिज (50 ग्राम)।', 'disease': 'थनैला (Mastitis), खुरपका-मुंहपका (FMD), और लम्पी त्वचा रोग।'},
        'rathi': {'name': 'राठी', 'type': 'गाय', 'origin': 'राजस्थान', 'lifespan': '13-15 वर्ष', 'milk': '8-12 लीटर/दिन', 'weight': '280-350 किग्रा', 'height': '115-125 सेमी', 'appearance': 'सफेद धब्बों के साथ भूरा रंग।', 'diet': 'हरा चारा (15-20 किलो), सूखा चारा (5-7 किलो), दाना (3-4 किलो), खनिज (50 ग्राम)।', 'disease': 'थनैला (Mastitis), खुरपका-मुंहपका (FMD), और लम्पी त्वचा रोग।'},
        'hariana': {'name': 'हरियाणवी', 'type': 'गाय', 'origin': 'हरियाणा', 'lifespan': '14-18 वर्ष', 'milk': '8-12 लीटर/दिन', 'weight': '350-500 किग्रा', 'height': '130-140 सेमी', 'appearance': 'सफेद या हल्का भूरा, लंबा चेहरा।', 'diet': 'सूखा चारा (6-8 किलो), चराई, दाना मिश्रण (2 किलो) और नमक।', 'disease': 'थनैला (Mastitis), खुरपका-मुंहपका (FMD), और लम्पी त्वचा रोग।'},
        'deoni': {'name': 'देओनी', 'type': 'गाय', 'origin': 'महाराष्ट्र/कर्नाटक', 'lifespan': '12-15 वर्ष', 'milk': '6-10 लीटर/दिन', 'weight': '400-500 किग्रा', 'height': '120-135 सेमी', 'appearance': 'काले और सफेद धब्बे, लटकते कान।', 'diet': 'हरा चारा (15-20 किलो), सूखा चारा (5-7 किलो), दाना (3-4 किलो), खनिज (50 ग्राम)।', 'disease': 'थनैला (Mastitis), खुरपका-मुंहपका (FMD), और लम्पी त्वचा रोग।'},
        'malnad gidda': {'name': 'मलनाड गिड्डा', 'type': 'गाय (बौनी)', 'origin': 'कर्नाटक', 'lifespan': '10-14 वर्ष', 'milk': '2-4 लीटर/दिन', 'weight': '120-200 किग्रा', 'height': '90-100 सेमी', 'appearance': 'छोटा कद, रोग प्रतिरोधी, फुर्तीली।', 'diet': 'चराई, सूखा चारा (2-3 किलो), और कम दाना।', 'disease': 'रोग प्रतिरोधी, लेकिन टिक्स और एफएमडी से बचाव जरूरी है।'},
        'banni': {'name': 'बन्नी', 'type': 'भैंस', 'origin': 'गुजरात (कच्छ)', 'lifespan': '15-20 वर्ष', 'milk': '12-15 लीटर/दिन', 'weight': '450-550 किग्रा', 'height': '130-140 सेमी', 'appearance': 'रात में चरने वाली, घुमावदार सींग।', 'diet': 'हरा चारा (20-25 किलो), सूखा चारा (8-10 किलो), उच्च प्रोटीन दाना (4-5 किलो), कैल्शियम।', 'disease': 'गलघोंटू (HS), खुरपका-मुंहपका (FMD), और ब्रुसेलोसिस।'},
        'jaffarabadi': {'name': 'जाफराबादी', 'type': 'भैंस', 'origin': 'गुजरात', 'lifespan': '18-22 वर्ष', 'milk': '15-20 लीटर/दिन', 'weight': '700-800 किग्रा', 'height': '140-150 सेमी', 'appearance': 'भारी शरीर, लटकते सींग।', 'diet': 'हरा चारा (20-25 किलो), सूखा चारा (8-10 किलो), उच्च प्रोटीन दाना (4-5 किलो), कैल्शियम।', 'disease': 'गलघोंटू (HS), खुरपका-मुंहपका (FMD), और ब्रुसेलोसिस।'},
        'nili ravi': {'name': 'नीली रावी', 'type': 'भैंस', 'origin': 'पंजाब', 'lifespan': '14-18 वर्ष', 'milk': '12-18 लीटर/दिन', 'weight': '500-600 किग्रा', 'height': '130-140 सेमी', 'appearance': 'सफेद आंखें, चेहरे और पैरों पर सफेद निशान।', 'diet': 'हरा चारा (20-25 किलो), सूखा चारा (8-10 किलो), उच्च प्रोटीन दाना (4-5 किलो), कैल्शियम।', 'disease': 'गलघोंटू (HS), खुरपका-मुंहपका (FMD), और ब्रुसेलोसिस।'},
        'mehsana': {'name': 'मेहसाणा', 'type': 'भैंस', 'origin': 'गुजरात', 'lifespan': '15-20 वर्ष', 'milk': '10-15 लीटर/दिन', 'weight': '450-550 किग्रा', 'height': '130-140 सेमी', 'appearance': 'मुर्रा और सुरती का संकर, दरांती जैसे सींग।', 'diet': 'हरा चारा (20-25 किलो), सूखा चारा (8-10 किलो), उच्च प्रोटीन दाना (4-5 किलो), कैल्शियम।', 'disease': 'गलघोंटू (HS), खुरपका-मुंहपका (FMD), और ब्रुसेलोसिस।'},
        'nagpuri': {'name': 'नागपुरी', 'type': 'भैंस', 'origin': 'महाराष्ट्र', 'lifespan': '15-18 वर्ष', 'milk': '5-8 लीटर/दिन', 'weight': '350-450 किग्रा', 'height': '120-130 सेमी', 'appearance': 'लंबे और चपटे तलवार जैसे सींग।', 'diet': 'हरा चारा (20-25 किलो), सूखा चारा (8-10 किलो), उच्च प्रोटीन दाना (4-5 किलो), कैल्शियम।', 'disease': 'गलघोंटू (HS), खुरपका-मुंहपका (FMD), और ब्रुसेलोसिस।'},
        'toda': {'name': 'टोडा', 'type': 'भैंस', 'origin': 'तमिलनाडु', 'lifespan': '15-18 वर्ष', 'milk': '4-6 लीटर/दिन', 'weight': '350-400 किग्रा', 'height': '120-130 सेमी', 'appearance': 'भूरा रंग, विशिष्ट अर्धचंद्राकार सींग।', 'diet': 'हरा चारा (20-25 किलो), सूखा चारा (8-10 किलो), उच्च प्रोटीन दाना (4-5 किलो), कैल्शियम।', 'disease': 'गलघोंटू (HS), खुरपका-मुंहपका (FMD), और ब्रुसेलोसिस।'}
      };
    } else if (lang == 'mr') {
      breedData = {
        'gir': {'name': 'गीर', 'type': 'गाय', 'origin': 'गुजरात (सौराष्ट्र)', 'lifespan': '12-15 वर्षे', 'milk': '12-20 लिटर/दिवस', 'weight': '385-545 किलो', 'height': '130-140 सेमी', 'appearance': 'बहिर्वक्र कपाळ, लांब लोंबकळणारे कान, लाल/ठिपकेदार.', 'diet': 'हिरवा चारा (15-20 किलो), सुका चारा (5-7 किलो), पशुखाद्य (3-4 किलो), खनिज (50 ग्रॅम).', 'disease': 'स्तनदाह (Mastitis), लाळ्या खुरकूत (FMD), आणि लम्पी त्वचा रोग.'},
        'sahiwal': {'name': 'साहीवाल', 'type': 'गाय', 'origin': 'पंजाब/हरियाणा', 'lifespan': '14-16 वर्षे', 'milk': '10-15 लिटर/दिवस', 'weight': '400-500 किलो', 'height': '120-130 सेमी', 'appearance': 'लाल-तपकिरी रंग, त्वचेच्या घड्या.', 'diet': 'हिरवा चारा (15-20 किलो), सुका चारा (5-7 किलो), पशुखाद्य (3-4 किलो), खनिज (50 ग्रॅम).', 'disease': 'स्तनदाह (Mastitis), लाळ्या खुरकूत (FMD), आणि लम्पी त्वचा रोग.'},
        'kankrej': {'name': 'कांकरेज', 'type': 'गाय', 'origin': 'गुजरात/राजस्थान', 'lifespan': '12-16 वर्षे', 'milk': '8-10 लिटर/दिवस', 'weight': '420-590 किलो', 'height': '130-140 सेमी', 'appearance': 'चांदी-तपकिरी रंग, मोठी मजबूत शिंगे.', 'diet': 'सुका चारा (6-8 किलो), चराई, पशुखाद्य (2 किलो) आणि मीठ.', 'disease': 'स्तनदाह (Mastitis), लाळ्या खुरकूत (FMD), आणि लम्पी त्वचा रोग.'},
        'ongole': {'name': 'ओंगोल', 'type': 'गाय', 'origin': 'आंध्र प्रदेश', 'lifespan': '15-20 वर्षे', 'milk': '5-8 लिटर/दिवस', 'weight': '430-500 किलो', 'height': '135-150 सेमी', 'appearance': 'पांढरा रंग, मोठे वशिंड, मजबूत शरीर.', 'diet': 'सुका चारा (6-8 किलो), चराई, पशुखाद्य (2 किलो) आणि मीठ.', 'disease': 'स्तनदाह (Mastitis), लाळ्या खुरकूत (FMD), आणि लम्पी त्वचा रोग.'},
        'red sindhi': {'name': 'लाल सिंधी', 'type': 'गाय', 'origin': 'सिंध/राजस्थान', 'lifespan': '12-15 वर्षे', 'milk': '12-18 लिटर/दिवस', 'weight': '300-450 किलो', 'height': '115-130 सेमी', 'appearance': 'गडद लाल रंग, कॉम्पॅक्ट फ्रेम.', 'diet': 'हिरवा चारा (15-20 किलो), सुका चारा (5-7 किलो), पशुखाद्य (3-4 किलो), खनिज (50 ग्रॅम).', 'disease': 'स्तनदाह (Mastitis), लाळ्या खुरकूत (FMD), आणि लम्पी त्वचा रोग.'},
        'tharparkar': {'name': 'थारपारकर', 'type': 'गाय', 'origin': 'राजस्थान', 'lifespan': '14-18 वर्षे', 'milk': '10-14 लिटर/दिवस', 'weight': '400-500 किलो', 'height': '120-140 सेमी', 'appearance': 'पांढरा/फिकट राखाडी रंग.', 'diet': 'हिरवा चारा (15-20 किलो), सुका चारा (5-7 किलो), पशुखाद्य (3-4 किलो), खनिज (50 ग्रॅम).', 'disease': 'स्तनदाह (Mastitis), लाळ्या खुरकूत (FMD), आणि लम्पी त्वचा रोग.'},
        'rathi': {'name': 'राठी', 'type': 'गाय', 'origin': 'राजस्थान', 'lifespan': '13-15 वर्षे', 'milk': '8-12 लिटर/दिवस', 'weight': '280-350 किलो', 'height': '115-125 सेमी', 'appearance': 'पांढऱ्या ठिपक्यांसह तपकिरी रंग.', 'diet': 'हिरवा चारा (15-20 किलो), सुका चारा (5-7 किलो), पशुखाद्य (3-4 किलो), खनिज (50 ग्रॅम).', 'disease': 'स्तनदाह (Mastitis), लाळ्या खुरकूत (FMD), आणि लम्पी त्वचा रोग.'},
        'hariana': {'name': 'हरियाणवी', 'type': 'गाय', 'origin': 'हरियाणा', 'lifespan': '14-18 वर्षे', 'milk': '8-12 लिटर/दिवस', 'weight': '350-500 किलो', 'height': '130-140 सेमी', 'appearance': 'पांढरा किंवा फिकट राखाडी, लांब चेहरा.', 'diet': 'सुका चारा (6-8 किलो), चराई, पशुखाद्य (2 किलो) आणि मीठ.', 'disease': 'स्तनदाह (Mastitis), लाळ्या खुरकूत (FMD), आणि लम्पी त्वचा रोग.'},
        'deoni': {'name': 'देवणी', 'type': 'गाय', 'origin': 'महाराष्ट्र/कर्नाटक', 'lifespan': '12-15 वर्षे', 'milk': '6-10 लिटर/दिवस', 'weight': '400-500 किलो', 'height': '120-135 सेमी', 'appearance': 'काळे आणि पांढरे ठिपके, लोंबकळणारे कान.', 'diet': 'हिरवा चारा (15-20 किलो), सुका चारा (5-7 किलो), पशुखाद्य (3-4 किलो), खनिज (50 ग्रॅम).', 'disease': 'स्तनदाह (Mastitis), लाळ्या खुरकूत (FMD), आणि लम्पी त्वचा रोग.'},
        'malnad gidda': {'name': 'मलनाड गिड्डा', 'type': 'गाय (बुटकी)', 'origin': 'कर्नाटक', 'lifespan': '10-14 वर्षे', 'milk': '2-4 लिटर/दिवस', 'weight': '120-200 किलो', 'height': '90-100 सेमी', 'appearance': 'लहान उंची, रोगप्रतिकारक, चपळ.', 'diet': 'चराई, सुका चारा (2-3 किलो), आणि थोडे पशुखाद्य.', 'disease': 'रोगप्रतिकारक, पण टिक्स आणि एफएमडी पासून संरक्षण आवश्यक.'},
        'banni': {'name': 'बन्नी', 'type': 'म्हैस', 'origin': 'गुजरात (कच्छ)', 'lifespan': '15-20 वर्षे', 'milk': '12-15 लिटर/दिवस', 'weight': '450-550 किलो', 'height': '130-140 सेमी', 'appearance': 'रात्री चरणाऱ्या, वळलेली शिंगे.', 'diet': 'हिरवा चारा (20-25 किलो), सुका चारा (8-10 किलो), उच्च प्रथिनेयुक्त पशुखाद्य (4-5 किलो).', 'disease': 'घटसर्प (HS), लाळ्या खुरकूत (FMD), आणि ब्रुसेलोसिस.'},
        'jaffarabadi': {'name': 'जाफराबादी', 'type': 'म्हैस', 'origin': 'गुजरात', 'lifespan': '18-22 वर्षे', 'milk': '15-20 लिटर/दिवस', 'weight': '700-800 किलो', 'height': '140-150 सेमी', 'appearance': 'जड शरीर, लोंबकळणारी शिंगे.', 'diet': 'हिरवा चारा (20-25 किलो), सुका चारा (8-10 किलो), उच्च प्रथिनेयुक्त पशुखाद्य (4-5 किलो).', 'disease': 'घटसर्प (HS), लाळ्या खुरकूत (FMD), आणि ब्रुसेलोसिस.'},
        'nili ravi': {'name': 'नीली रावी', 'type': 'म्हैस', 'origin': 'पंजाब', 'lifespan': '14-18 वर्षे', 'milk': '12-18 लिटर/दिवस', 'weight': '500-600 किलो', 'height': '130-140 सेमी', 'appearance': 'पांढरे डोळे, चेहरा आणि पायांवर पांढरे डाग.', 'diet': 'हिरवा चारा (20-25 किलो), सुका चारा (8-10 किलो), उच्च प्रथिनेयुक्त पशुखाद्य (4-5 किलो).', 'disease': 'घटसर्प (HS), लाळ्या खुरकूत (FMD), आणि ब्रुसेलोसिस.'},
        'mehsana': {'name': 'मेहसाणा', 'type': 'म्हैस', 'origin': 'गुजरात', 'lifespan': '15-20 वर्षे', 'milk': '10-15 लिटर/दिवस', 'weight': '450-550 किलो', 'height': '130-140 सेमी', 'appearance': 'विळ्याच्या आकाराची शिंगे.', 'diet': 'हिरवा चारा (20-25 किलो), सुका चारा (8-10 किलो), उच्च प्रथिनेयुक्त पशुखाद्य (4-5 किलो).', 'disease': 'घटसर्प (HS), लाळ्या खुरकूत (FMD), आणि ब्रुसेलोसिस.'},
        'nagpuri': {'name': 'नागपुरी', 'type': 'म्हैस', 'origin': 'महाराष्ट्र', 'lifespan': '15-18 वर्षे', 'milk': '5-8 लिटर/दिवस', 'weight': '350-450 किलो', 'height': '120-130 सेमी', 'appearance': 'लांब आणि सपाट तलवारीसारखी शिंगे.', 'diet': 'हिरवा चारा (20-25 किलो), सुका चारा (8-10 किलो), उच्च प्रथिनेयुक्त पशुखाद्य (4-5 किलो).', 'disease': 'घटसर्प (HS), लाळ्या खुरकूत (FMD), आणि ब्रुसेलोसिस.'},
        'toda': {'name': 'टोडा', 'type': 'म्हैस', 'origin': 'तमिळनाडू', 'lifespan': '15-18 वर्षे', 'milk': '4-6 लिटर/दिवस', 'weight': '350-400 किलो', 'height': '120-130 सेमी', 'appearance': 'राखाडी रंग, अर्धचंद्राकृती शिंगे.', 'diet': 'हिरवा चारा (20-25 किलो), सुका चारा (8-10 किलो), उच्च प्रथिनेयुक्त पशुखाद्य (4-5 किलो).', 'disease': 'घटसर्प (HS), लाळ्या खुरकूत (FMD), आणि ब्रुसेलोसिस.'}
      };
    } else {
      breedData = {
        'gir': {'name': 'Gir', 'type': 'Cow', 'origin': 'Gujarat (Saurashtra)', 'lifespan': '12-15 years', 'milk': '12-20 Liters/day', 'weight': '385-545kg', 'height': '130 - 140 cm', 'appearance': 'Convex forehead, long pendulous ears, red/spotted.', 'diet': 'Green fodder (15-20kg), Dry fodder (5-7kg), Concentrate (3-4kg), Minerals (50g).', 'disease': 'Mastitis, Foot & Mouth Disease (FMD), and Lumpy Skin Disease.'},
        'sahiwal': {'name': 'Sahiwal', 'type': 'Cow', 'origin': 'Punjab/Haryana', 'lifespan': '14-16 years', 'milk': '10-15 Liters/day', 'weight': '400-500kg', 'height': '120 - 130 cm', 'appearance': 'Reddish brown color, heavy skin folds, prominent dewlap.', 'diet': 'Green fodder (15-20kg), Dry fodder (5-7kg), Concentrate (3-4kg), Minerals (50g).', 'disease': 'Mastitis, Foot & Mouth Disease (FMD), and Lumpy Skin Disease.'},
        'kankrej': {'name': 'Kankrej', 'type': 'Cow', 'origin': 'Gujarat/Rajasthan', 'lifespan': '12-16 years', 'milk': '8-10 Liters/day', 'weight': '420-590kg', 'height': '130 - 140 cm', 'appearance': 'Silver-grey to iron-grey, large strong crescent horns.', 'diet': 'Dry fodder (6-8kg), Grazing, Concentrate (2kg), and Salt.', 'disease': 'Mastitis, Foot & Mouth Disease (FMD), and Lumpy Skin Disease.'},
        'ongole': {'name': 'Ongole', 'type': 'Cow', 'origin': 'Andhra Pradesh', 'lifespan': '15-20 years', 'milk': '5-8 Liters/day', 'weight': '430-500kg', 'height': '135 - 150 cm', 'appearance': 'Glossy white, huge hump, short horns, muscular build.', 'diet': 'Dry fodder (6-8kg), Grazing, Concentrate (2kg), and Salt.', 'disease': 'Mastitis, Foot & Mouth Disease (FMD), and Lumpy Skin Disease.'},
        'red sindhi': {'name': 'Red Sindhi', 'type': 'Cow', 'origin': 'Sindh/Rajasthan', 'lifespan': '12-15 years', 'milk': '12-18 Liters/day', 'weight': '300-450kg', 'height': '115 - 130 cm', 'appearance': 'Deep red color, compact frame, thick horns.', 'diet': 'Green fodder (15-20kg), Dry fodder (5-7kg), Concentrate (3-4kg), Minerals (50g).', 'disease': 'Mastitis, Foot & Mouth Disease (FMD), and Lumpy Skin Disease.'},
        'tharparkar': {'name': 'Tharparkar', 'type': 'Cow', 'origin': 'Rajasthan', 'lifespan': '14-18 years', 'milk': '10-14 Liters/day', 'weight': '400-500kg', 'height': '120 - 140 cm', 'appearance': 'White/light grey color, lyre-shaped horns.', 'diet': 'Green fodder (15-20kg), Dry fodder (5-7kg), Concentrate (3-4kg), Minerals (50g).', 'disease': 'Mastitis, Foot & Mouth Disease (FMD), and Lumpy Skin Disease.'},
        'rathi': {'name': 'Rathi', 'type': 'Cow', 'origin': 'Rajasthan', 'lifespan': '13-15 years', 'milk': '8-12 Liters/day', 'weight': '280-350kg', 'height': '115 - 125 cm', 'appearance': 'Brown with white patches, medium horns, efficient in arid regions.', 'diet': 'Green fodder (15-20kg), Dry fodder (5-7kg), Concentrate (3-4kg), Minerals (50g).', 'disease': 'Mastitis, Foot & Mouth Disease (FMD), and Lumpy Skin Disease.'},
        'hariana': {'name': 'Hariana', 'type': 'Cow', 'origin': 'Haryana', 'lifespan': '14-18 years', 'milk': '8-12 Liters/day', 'weight': '350-500kg', 'height': '130 - 140 cm', 'appearance': 'White or light grey, long narrow face, small horns.', 'diet': 'Dry fodder (6-8kg), Grazing, Concentrate (2kg), and Salt.', 'disease': 'Mastitis, Foot & Mouth Disease (FMD), and Lumpy Skin Disease.'},
        'deoni': {'name': 'Deoni', 'type': 'Cow', 'origin': 'Maharashtra/Karnataka', 'lifespan': '12-15 years', 'milk': '6-10 Liters/day', 'weight': '400-500kg', 'height': '120 - 135 cm', 'appearance': 'Black and white patches, prominent forehead, drooping ears.', 'diet': 'Green fodder (15-20kg), Dry fodder (5-7kg), Concentrate (3-4kg), Minerals (50g).', 'disease': 'Mastitis, Foot & Mouth Disease (FMD), and Lumpy Skin Disease.'},
        'malnad gidda': {'name': 'Malnad Gidda', 'type': 'Cow (Dwarf)', 'origin': 'Karnataka', 'lifespan': '10-14 years', 'milk': '2-4 Liters/day', 'weight': '120-200kg', 'height': '90 - 100 cm', 'appearance': 'Small/dwarf stature, highly disease resistant, agile.', 'diet': 'Grazing, Dry fodder (2-3kg), and minimal concentrate.', 'disease': 'Highly disease resistant, but susceptible to ticks and FMD.'},
        'banni': {'name': 'Banni', 'type': 'Buffalo', 'origin': 'Gujarat (Kutch)', 'lifespan': '15-20 years', 'milk': '12-15 Liters/day', 'weight': '450-550kg', 'height': '130 - 140 cm', 'appearance': 'Night grazers, black, typical coiled horns.', 'diet': 'Green fodder (20-25kg), Dry fodder (8-10kg), High-protein concentrate (4-5kg).', 'disease': 'Hemorrhagic Septicemia (HS), FMD, and Brucellosis.'},
        'jaffarabadi': {'name': 'Jaffarabadi', 'type': 'Buffalo', 'origin': 'Gujarat', 'lifespan': '18-22 years', 'milk': '15-20 Liters/day', 'weight': '700-800kg', 'height': '140 - 150 cm', 'appearance': 'Heavy built, massive body, drooping horns.', 'diet': 'Green fodder (20-25kg), Dry fodder (8-10kg), High-protein concentrate (4-5kg).', 'disease': 'Hemorrhagic Septicemia (HS), FMD, and Brucellosis.'},
        'nili ravi': {'name': 'Nili Ravi', 'type': 'Buffalo', 'origin': 'Punjab', 'lifespan': '14-18 years', 'milk': '12-18 Liters/day', 'weight': '500-600kg', 'height': '130 - 140 cm', 'appearance': 'Wall eyes, white markings on face and legs.', 'diet': 'Green fodder (20-25kg), Dry fodder (8-10kg), High-protein concentrate (4-5kg).', 'disease': 'Hemorrhagic Septicemia (HS), FMD, and Brucellosis.'},
        'mehsana': {'name': 'Mehsana', 'type': 'Buffalo', 'origin': 'Gujarat', 'lifespan': '15-20 years', 'milk': '10-15 Liters/day', 'weight': '450-550kg', 'height': '130 - 140 cm', 'appearance': 'Cross between Murrah and Surti, sickle-shaped horns.', 'diet': 'Green fodder (20-25kg), Dry fodder (8-10kg), High-protein concentrate (4-5kg).', 'disease': 'Hemorrhagic Septicemia (HS), FMD, and Brucellosis.'},
        'nagpuri': {'name': 'Nagpuri', 'type': 'Buffalo', 'origin': 'Maharashtra', 'lifespan': '15-18 years', 'milk': '5-8 Liters/day', 'weight': '350-450kg', 'height': '120 - 130 cm', 'appearance': 'Long, flat, sword-shaped horns.', 'diet': 'Green fodder (20-25kg), Dry fodder (8-10kg), High-protein concentrate (4-5kg).', 'disease': 'Hemorrhagic Septicemia (HS), FMD, and Brucellosis.'},
        'toda': {'name': 'Toda', 'type': 'Buffalo', 'origin': 'Tamil Nadu', 'lifespan': '15-18 years', 'milk': '4-6 Liters/day', 'weight': '350-400kg', 'height': '120 - 130 cm', 'appearance': 'Fawn to ash-grey color, distinct crescent-shaped horns.', 'diet': 'Green fodder (20-25kg), Dry fodder (8-10kg), High-protein concentrate (4-5kg).', 'disease': 'Hemorrhagic Septicemia (HS), FMD, and Brucellosis.'}
      };
    }
    ...
    return {
      ...
      'diet': 'General cattle feed', 'disease': 'Consult a veterinarian for specific vulnerabilities.'
    };
  }
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const Divider(),
                        _infoText("${translate('dialog_diet')}: ${details['diet'] ?? ''}"),
                        const SizedBox(height: 5),
                        // <-- ADDED DISEASE INFO TO UI -->
                        Text(
                          "${translate('dialog_disease')}: ${details['disease'] ?? ''}",
